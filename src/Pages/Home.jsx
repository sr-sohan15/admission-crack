...
const Home = () => {
  return (
    <div className="space-y-8 sm:space-y-10 max-w-5xl mx-auto py-4 px-4 sm:px-6">
      ...
      <div className="bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-6 sm:p-12 text-center space-y-4 shadow-xl">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <Link
            to="/science"
            className="bg-slate-900 border border-emerald-500/30 hover:border-emerald-500 p-6 sm:p-8 rounded-3xl transition-all space-y-4 group shadow-lg shadow-emerald-950/20 flex flex-col justify-between cursor-pointer"
          >
            ...
            <div className="flex justify-between items-center pt-4 border-t border-slate-800 text-xs sm:text-sm font-bold text-emerald-400">
          ...
          <div className="bg-slate-900/40 border border-slate-800/80 p-6 sm:p-8 rounded-3xl space-y-4 opacity-60 flex flex-col justify-between cursor-not-allowed">
            ...
            <div className="flex justify-between items-center pt-4 border-t border-slate-800 text-xs sm:text-sm font-bold text-slate-500">
